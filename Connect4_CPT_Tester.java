...
{// Start Class
    ...
    {// Start method
        ...
        {// start for loop
            ...
            {// start for loop
                if (((Array[x][y] == 1) && (Array[x][y + 1] == 1) && (Array[x][y + 2] == 1) && (Array[x][y + 3] == 1))
                        || ((Array[x][y] == 2) && (Array[x][y + 1] == 2) && (Array[x][y + 2] == 2)
                                && (Array[x][y + 3] == 2))) // true branch
        ...
        {// start for loop
            ...
            {// start for loop
                if ((Array[x][y] == 1) && (Array[x + 1][y] == 1) && (Array[x + 2][y] == 1) && (Array[x + 3][y] == 1)
                        || (Array[x][y] == 2) && (Array[x + 1][y] == 2) && (Array[x + 2][y] == 2)
                                && (Array[x + 3][y] == 2))// true branch
                    Win = true; // if true var=true
            }
        } // end for loop
        ...
        {// start for loop
            ...
            {// start for loop
                if ((Array[count][count + i] == 1) && (Array[1 + count][1 + count + i] == 1)
                        && (Array[2 + count][2 + count + i] == 1) && (Array[3 + count][3 + count + i] == 1)
                        || (Array[count][count + i] == 2) && (Array[1 + count][1 + count + i] == 2)
                                && (Array[2 + count][2 + count + i] == 2) && (Array[3 + count][3 + count + i] == 2))// true
                                                                                                                    // branch
                    Win = true; // if true var=true
            } // end for loop
            ...
            for (int count = 0; count < 3; count++)// create for loop
            {// start for loop
                if (((Array[5 - count][count + i] == 1) && (Array[4 - count][count + i + 1] == 1)
                        && (Array[3 - count][count + i + 2] == 1) && (Array[2 - count][count + i + 3] == 1))
                        || ((Array[5 - count][count + i] == 2) && (Array[4 - count][count + i + 1] == 2)
                                && (Array[3 - count][count + i + 2] == 2) && (Array[2 - count][count + i + 3] == 2)))// true
                                                                                                                     // branch
                    Win = true; // if true var=true
            } // end for loop
        ...
        {// start for loop
            if ((Array[4 - count][0 + count] == 1) && (Array[3 - count][1 + count] == 1)
                    && (Array[2 - count][2 + count] == 1) && (Array[1 - count][3 + count] == 1)
                    || (Array[4 - count][0 + count] == 2) && (Array[3 - count][1 + count] == 2)
                            && (Array[2 - count][2 + count] == 2) && (Array[1 - count][3 + count] == 2))// true branch
                Win = true; // if true var=true
        } // end for loop

        for (int count = 0; count < 2; count++)// create for loop, right side with 2 combinations
        {// start for loop
            if ((Array[5 - count][2 + count] == 1) && (Array[4 - count][3 + count] == 1)
                    && (Array[3 - count][4 + count] == 1) && (Array[2 - count][5 + count] == 1)
                    || (Array[5 - count][2 + count] == 2) && (Array[4 - count][3 + count] == 2)
                            && (Array[3 - count][4 + count] == 2) && (Array[2 - count][5 + count] == 2))// true branch
                Win = true; // if true var=true
        } // end for loop

        for (int count = 0; count < 2; count++)// create for loop, opposite side (right most side)
        {// start for loop
            if ((Array[5 - count][4 - count] == 1) && (Array[4 - count][3 - count] == 1)
                    && (Array[3 - count][2 - count] == 1) && (Array[2 - count][1 - count] == 1)
                    || (Array[5 - count][4 - count] == 2) && (Array[4 - count][3 - count] == 2)
                            && (Array[3 - count][2 - count] == 2) && (Array[2 - count][1 - count] == 2))// true branch
                Win = true; // if true var=true
        } // end for loop

        for (int count = 0; count < 2; count++)// create for loop, opposite side (top right side to higher left
        {// start for loop
            if ((Array[4 - count][6 - count] == 1) && (Array[3 - count][5 - count] == 1)
                    && (Array[2 - count][4 - count] == 1) && (Array[1 - count][3 - count] == 1)
                    || (Array[4 - count][6 - count] == 2) && (Array[3 - count][5 - count] == 2)
                            && (Array[2 - count][4 - count] == 2) && (Array[1 - count][3 - count] == 2))// true branch
                Win = true; // if true var=true
        } // end for loop

        if ((Array[3][0] == 1) && (Array[2][1] == 1) && (Array[1][2] == 1) && (Array[0][3] == 1)
                || (Array[3][0] == 2) && (Array[2][1] == 2) && (Array[1][2] == 2) && (Array[0][3] == 2))// true branch
            Win = true; // if true var=true
        else if ((Array[3][6] == 1) && (Array[2][4] == 1) && (Array[1][4] == 1) && (Array[0][3] == 1)
                || (Array[3][6] == 2) && (Array[2][4] == 2) && (Array[1][4] == 2))// true branch
            Win = true; // if true var=true

        else if ((Array[5][3] == 1) && (Array[4][2] == 1) && (Array[3][1] == 1) && (Array[2][0] == 1)
                || (Array[5][3] == 2) && (Array[4][2] == 2) && (Array[3][1] == 2) && (Array[2][0] == 2))// true branch
            Win = true; // if true var=true

        else if ((Array[5][3] == 1) && (Array[4][4] == 1) && (Array[3][5] == 1) && (Array[2][6] == 1)
                || (Array[5][3] == 2) && (Array[4][4] == 2) && (Array[3][5] == 2) && (Array[2][6] == 2))// true branch
            Win = true; // if true, var= true
        return Win;
    }// End method
...
public class Connect4_CPT_Tester extends javax.swing.JFrame {// Start class
    ...
    // changes colour of each players name so players know whose turn it is, keeps
    // track of turns
    ...
    {// Start method
        ...
        {// start true branch
            ...
            label3.setForeground(Color.green); // set label colour
    ...
    {// Start method
        if (c2.Win == true && Player == 1)// True branch
            JOptionPane.showMessageDialog(null,
                    "Congratualtions " + PName1 + "! You won! Please press reset to play again."); // outputs new window
        else if (c2.Win == true && Player == 2 && num_of_players == 1)// create branch
            JOptionPane.showMessageDialog(null, "Sorry " + PName1 + ". You lost. Please press reset to play again."); // outputs
                                                                                                                      // new
                                                                                                                      // window
        else if (c2.Win == true && Player == 2)// create branch
            JOptionPane.showMessageDialog(null,
                    "Congratualtions " + PName2 + "! You won! Please press reset to play again."); // outputs new window
        else if (Turn == 41)// create branch
            JOptionPane.showMessageDialog(null,
                    "All slots are full. Neither player has won. Please press reset if you wish to play again."); // outputs
                                                                                                                  // new
                                                                                                                  // window
        if (Win == true)// true branch, will set reset to default so player is forced to press reset
                        // when trying to continue playing (meets condition of else if statment in each
                        // button method).
            Reset = false;// reassign var
    }// End method

    // all column methods were made so that they could be used for each button event
    // and for the One_player method.
    void column1()// create method
    {// start method
        if (Array[0][0] != 0)// true branch, ensures players do not try to place a game piece in a full
                             // column
            JOptionPane.showMessageDialog(null, "Please choose a column that is not full."); // will output a window
        else if (Array[5][0] == 0) // create branch, else if statements ensure the pieces dropped start at the
                                   // bottom most slot.
        {// Start branch
            label11.setText("O"); // set label text
            if (Player == 1)// True branch, will assign a different number to the array and display a
                            // different colour piece depending on the player
            {// Start true branch
            ...
            {// start false branch
                label11.setForeground(Color.green); // set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label12.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label10.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label9.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label8.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label7.setForeground(Color.green);// set label colour
                Array[0][0] = 2; // Reassign array value
            } // End false branch
        } // end branch
        c2.Checkwin(Array);// calls method, checks for win after each turn
        Displaywin();// calls method, checks to see if a win needs to be announced/end of game each
                     // turn
        Changelabel(); // calls method, will change colour of player labels and keep track of turns
                       // each turn
    }// End method
    ...
    {// Start method
        ...
        {// Start true branch
            ...
            {// Start false branch
                label13.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label14.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label15.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label16.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label17.setForeground(Color.green); // set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label18.setForeground(Color.green); // set label colour
    ...
    {// Start method
        ...
        {// Start true branch
            ...
            {// Start false branch
                label19.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label20.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label21.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label22.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label23.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label24.setForeground(Color.green);// set label colour
    ...
    {// Start method
        ...
        {// Start true branch
            ...
            {// start false branch
                label25.setForeground(Color.green); // set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label26.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label27.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label49.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label29.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label30.setForeground(Color.green);// set label colour
    ...
    {// Start method
        ...
        {// Start true branch
            ...
            {// start false branch
                label31.setForeground(Color.green); // set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label32.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label33.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label34.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label35.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label36.setForeground(Color.green);// set label colour
    ...
    {// Start method
        ...
        {// Start true branch
            ...
            {// start false branch
                label37.setForeground(Color.green); // set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label38.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label39.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label40.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label41.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// start false branch
                label42.setForeground(Color.green);// set label colour
    ...
    {// Start method
        ...
        {// Start true branch
            ...
            {// Start false branch
                label4.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label5.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label43.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label44.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label45.setForeground(Color.green);// set label colour
        ...
        {// Start branch
            ...
            {// Start false branch
                label46.setForeground(Color.green);// set label colour
    ...
    {// start method
        if (num_of_players == 1 && c2.Win == false)// true branch, will run as long as player 1 has not won and 1 player
                                                   // is selected.
        {// start true branch
            do // create do while loop
            {// start do while loop
                column = ThreadLocalRandom.current().nextInt(0, 6); // assigns var a random int from 0 to 5 (picks which
                                                                    // column a piece will be dropped.)
                ...
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(label1, javax.swing.GroupLayout.PREFERRED_SIZE, 64,
        ...
        jPanel8Layout.setHorizontalGroup(
                jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel8Layout.createSequentialGroup()
                                .addComponent(label30, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
        ...
        jPanel9Layout.setHorizontalGroup(
                jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel9Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(label41, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
        ...
        jPanel10Layout.setHorizontalGroup(
                jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel10Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(label45, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
        ...
        jPanel12Layout.setHorizontalGroup(
                jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel12Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(label46, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
        ...
        jPanel13Layout.setHorizontalGroup(
                jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel13Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(label44, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
        ...
        jPanel14Layout.setHorizontalGroup(
                jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel14Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(label49, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
        jPanel14Layout.setVerticalGroup(
                jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(label49, javax.swing.GroupLayout.Alignment.TRAILING,
        ...
        jPanel17Layout.setHorizontalGroup(
                jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel17Layout.createSequentialGroup()
                                .addComponent(label35, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
        ...
        jPanel18Layout.setHorizontalGroup(
                jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel18Layout.createSequentialGroup()
                                .addComponent(label36, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
        ...
        jPanel19Layout.setHorizontalGroup(
                jPanel19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel19Layout.createSequentialGroup()
                                .addComponent(label29, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
        ...
        jPanel22Layout.setHorizontalGroup(
                jPanel22Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel22Layout.createSequentialGroup()
                                .addComponent(label34, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
        ...
        jPanel23Layout.setHorizontalGroup(
                jPanel23Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel23Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(label42, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
        ...
        jPanel25Layout.setHorizontalGroup(
                jPanel25Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel25Layout.createSequentialGroup()
                                .addComponent(label27, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
        ...
        jPanel26Layout.setHorizontalGroup(
                jPanel26Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel26Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(label40, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
        ...
        jPanel30Layout.setHorizontalGroup(
                jPanel30Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel30Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(label43, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
        ...
        jPanel31Layout.setHorizontalGroup(
                jPanel31Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel31Layout.createSequentialGroup()
                                .addComponent(label33, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
        ...
        jPanel32Layout.setHorizontalGroup(
                jPanel32Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel32Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(label39, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
        ...
        jPanel33Layout.setHorizontalGroup(
                jPanel33Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel33Layout.createSequentialGroup()
                                .addComponent(label25, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
        ...
        jPanel34Layout.setHorizontalGroup(
                jPanel34Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel34Layout.createSequentialGroup()
                                .addComponent(label26, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
        ...
        jPanel38Layout.setHorizontalGroup(
                jPanel38Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel38Layout.createSequentialGroup()
                                .addComponent(label32, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
        ...
        jPanel39Layout.setHorizontalGroup(
                jPanel39Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel39Layout.createSequentialGroup()
                                .addComponent(label38, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
        ...
        jPanel41Layout.setHorizontalGroup(
                jPanel41Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel41Layout.createSequentialGroup()
                                .addComponent(label31, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
        ...
        jPanel42Layout.setHorizontalGroup(
                jPanel42Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel42Layout.createSequentialGroup()
                                .addComponent(label37, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                                ...
                                                                                .addGroup(jPanel1Layout
                                                                                        ...
                                                                                        .addGroup(jPanel1Layout
                                                                                                ...
                                                                                                .addComponent(jPanel4,
                                                                                                        ...
                                                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                .addGap(18, 18, 18)
                                                                                                .addComponent(jPanel36,
                                                                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                .addGap(18, 18, 18)
                                                                                                .addComponent(jPanel34,
                                                                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                                                                        .addGroup(jPanel1Layout
                                                                                                .createSequentialGroup()
                                                                                                .addComponent(jPanel37,
                                                                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                .addGap(18, 18, 18)
                                                                                                .addComponent(jPanel35,
                                                                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                .addGap(18, 18, 18)
                                                ...
                                                .addContainerGap())
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addComponent(button9, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel1Layout
                                                        ...
                                                        .addComponent(jPanel38, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(jPanel39, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                ...
                                                .addGroup(jPanel1Layout
                                                        ...
                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                ...
                                                                .addComponent(label48,
                                                                        ...
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                                .addGap(68, 68, 68)
                                                .addComponent(button11, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_button1ActionPerformed
        ...
        if (num_of_players == 0)// true branch, if and if else statments ensures game is always reset/num of
                                // players is always selected
    ...
    private void button9ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_button9ActionPerformed
        ...
        {// Start false branch
            ...
            button10.setVisible(true);// make button visible, makes buttons and labels for choosing num of players
                                      // visible
    ...
    private void button8ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_button8ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Instructions:\nThe objective of the game is to get four of your "
                + "respective \ncoloured cicle tile (red if player 1 or green if player two) in a row, \neither "
    ...
    private void button10ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_button10ActionPerformed
        ...
        {// start branch
            do // create do while loop
            {// Start loop
                PName1 = JOptionPane.showInputDialog("Enter Player 1 name that is less than 10 characters: "); // outputs
                                                                                                               // window
                                                                                                               // that
                                                                                                               // takes
                                                                                                               // input
            ...
            } while (PName1.equals("") || PName1.length() > 10);// end loop (conditions will prevent player from just
                                                                // pressing enter)
        } // end branch
        label3.setText("Computer"); // sets labels text
        button10.setVisible(false);// make button invisible, makes buttons/labels to choose a player disapear so
                                   // player cannot cheat and change it in middle of game.
    ...
    private void button11ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_button11ActionPerformed
        ...
        if (Reset == false || label_text.equalsIgnoreCase("Computer"))// create branch (this will only make the players
                                                                      // enter their names at the start of the game and
                                                                      // when oenplayer was player the game before.
        {// start branch
            do // create do while loop
            {// Start loop
                PName1 = JOptionPane.showInputDialog("Enter Player 1 name that is less than 10 characters: "); // outputs
                                                                                                               ...
                                                                                                               // var
                label2.setText(PName1); // Set label text
                PName2 = JOptionPane.showInputDialog("Enter Player 2 name that is less than 10 characters: "); // outputs
                                                                                                               // window
                                                                                                               // that
                                                                                                               // takes
                                                                                                               // input
            ...
            } while (PName1.equals("") || PName2.equals("") || PName1.length() > 10 || PName2.length() > 10); // end
                                                                                                              // loop
                                                                                                              // (conditions
                                                                                                              // will
                                                                                                              // prevent
    ...
    public static void main(String args[]) {// Start main program
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Connect4_CPT_Tester.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
